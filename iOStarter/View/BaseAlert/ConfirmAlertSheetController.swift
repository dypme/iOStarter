//
//  ConfirmAlertSheetController.swift
//  iOStarter
//
...
class ConfirmAlertSheetController: AlertSheetController {

    @IBOutlet weak var cancelButton: UIButton!
    
    init(image: UIImage?, title: String, message: String?, actionText: String) {
        super.init(image: image, title: title, message: message, nibName: "ConfirmAlertSheetView")
